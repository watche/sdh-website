...
<SDHWriting>
  ...
  <SDHParagraph>
    ...
    <List class="inline" list="none">
      ...
      <Li><BlueManaSymbol /> The raindrop icon for the Blue mana symbol was <em>also</em> taken from <a href="https://lorcblog.blogspot.com/" class="underline">Lorc</a> via <a href="https://game-icons.net/1x1/lorc/drop.html" class="underline">game-icons.net</a>. <Clarification>It has also been modified<span slot="clarification">Flipped horizontally, scaled up a bit, and reshaped the little shine; MtG's is shorter and fatter. Notably, MtG's blue mana symbol is actually very unusual for having its "shine" on the right side instead of the left.</span></Clarification>.</Li>
